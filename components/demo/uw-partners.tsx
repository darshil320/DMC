  ...
  { 
    ...
    logo: (
      <svg viewBox="0 0 200 50" className="h-8 md:h-10 w-auto">
        ...
        <text x="40" y="33" fontFamily="Arial, sans-serif" fontWeight="900" fontSize="24" className="fill-uw-text-primary" letterSpacing="0.5">MERRYFAIR</text>
      </svg>
    )
  },
  { 
    ...
    logo: (
      <svg viewBox="0 0 200 50" className="h-8 md:h-10 w-auto">
        <text x="0" y="35" fontFamily="Georgia, serif" fontWeight="700" fontSize="30" className="fill-uw-text-primary" letterSpacing="0">SPACEWOOD</text>
      </svg>
    )
  },
  { 
    ...
    logo: (
      <svg viewBox="0 0 200 50" className="h-7 md:h-9 w-auto mt-1">
        <text x="0" y="33" fontFamily="Helvetica, Arial, sans-serif" fontWeight="700" fontSize="32" className="fill-uw-text-primary" letterSpacing="-1.5">Humanscale</text>
      </svg>
    )
  },
];
      ...
      <ul className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
        {PARTNERS.map((partner, idx) => (
          ...
          >
            ...
            <span className="text-[12px] font-medium tracking-[0.15em] uppercase text-uw-text-muted group-hover:text-uw-text-primary transition-colors duration-500">
              {partner.role}
            </span>
          </motion.li>
        ))}
