          ...
          {WHY_POINTS.map((point, idx) => {
            ...
            return (
              <motion.div
                ...
                className="text-center p-6 rounded-2xl border border-uw-brown/10 hover:border-uw-brown/30 hover:bg-uw-cream transition-all duration-300"
              >
                <div className="inline-flex size-12 items-center justify-center rounded-xl bg-uw-brown/10 mb-4">
                  <Icon className="size-6 text-uw-brown" />
                </div>
                <h3 className="text-uw-brown font-bold mb-2">{point.title}</h3>
                <p className="text-uw-brown/60 text-sm leading-relaxed">
                  {point.description}
                </p>
              </motion.div>
            );
