...
export function FCLegacy() {
  return (
    <section className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 pt-32 pb-12 md:pt-32 md:pb-2 border-t border-[#E6DED2]">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16">
        ...
        >
          ...
          <h2 className="text-[32px] md:text-[48px] font-serif text-[#1F1A16] leading-[1.1] mb-6">
        ...
        >
          <p className="text-[16px] md:text-[18px] leading-[1.6] text-[#5F554B] mb-6 max-w-xl">
          ...
          <p className="text-[16px] md:text-[18px] leading-[1.6] text-[#5F554B] max-w-xl">
